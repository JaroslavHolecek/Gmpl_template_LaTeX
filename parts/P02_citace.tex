...
V \LaTeX u lze generovat různé obsahy, jako je obsah kapitol, seznam obrázků nebo tabulek. Tyto obsahy se vytvářejí pomocí příkazů jako \verb|\tableofcontents|, \verb|\listoffigures|, \verb|\listoftables| a podobně. Tyto příkazy vložíte na místo, kde chcete, aby se obsah objevil, a \LaTeX\ automaticky vytvoří odpovídající seznamy na základě označení a struktur vašeho dokumentu.
